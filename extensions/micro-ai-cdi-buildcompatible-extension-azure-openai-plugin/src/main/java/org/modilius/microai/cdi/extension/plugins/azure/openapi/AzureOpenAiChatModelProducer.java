...
public class AzureOpenAiChatModelProducer {
    ...
    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.endpoint")
    private String AZURE_OPENAI_ENDPOINT;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.api.key")
    private String AZURE_OPENAI_KEY;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.deployment.name")
    private String AZURE_OPENAI_DEPLOYMENT_NAME;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.service.version", defaultValue = "2024-02-15-preview")
    private String AZURE_OPENAI_SERVICE_VERSION;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.temperature", defaultValue = "0.1")
    private Double AZURE_OPENAI_TEMPERATURE;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.top.p", defaultValue = "0.1")
    private Double AZURE_OPENAI_TOP_P;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.timeout.seconds", defaultValue = "120")
    private Integer AZURE_OPENAI_TIMEOUT_SECONDS;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.max.retries", defaultValue = "2")
    private Integer AZURE_OPENAI_MAX_RETRIES;

    @Inject
    @ConfigProperty(name = "micro.ai.plugin.azure.openai.log.requests.and.responses", defaultValue = "false")
